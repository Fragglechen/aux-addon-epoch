...
do
    ...
    btn:SetText('Next')
    btn:SetScript('OnClick', select_next_item)
    next_item_button = btn
end
do
    local btn = gui.button(frame.parameters)
    btn:SetPoint('TOPLEFT', next_item_button, 'TOPRIGHT', 5, 0)
    btn:SetText('Buyout')
    btn:SetScript('OnClick', buyout_selected_auction)
    buyout_auction_button = btn
end
do
    local btn = gui.button(frame.parameters)
    btn:SetPoint('TOPLEFT', buyout_auction_button, 'TOPRIGHT', 5, 0)
    btn:SetText('Refresh')
...
do
    ...
    editbox.char = function() bid_selection, buyout_selection = nil, nil; unit_start_price = money.from_string(this:GetText()); user_price_override = true end
...
do
    ...
    editbox.char = function() buyout_selection = nil; unit_buyout_price = money.from_string(this:GetText()); user_price_override = true end
    editbox.change = function() refresh = true end
    editbox.enter = function() this:ClearFocus() end
    editbox.focus_loss = function()
